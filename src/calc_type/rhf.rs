...
use crate::mol_int_and_deriv::oe_int::{
    calc_kinetic_int_cgto, calc_overlap_int_cgto, calc_pot_int_cgto,
};
use crate::molecule::Molecule;
use ndarray::Array2;

pub fn calc_1e_int_matrs(basis: &BasisSet, mol: &Molecule) -> (Array2<f64>, Array2<f64>, Array2<f64>) {
