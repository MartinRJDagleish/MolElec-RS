...
mod libint_sad_sto3g {
    use crate::molecule::Molecule;
    use ndarray::Array2;

    pub fn compute_sad_guess(mol: &Molecule) -> Array2<f64> {
    ...
    fn calc_occup_vec(z_val: u32) -> Vec<f64> {
        ...
        match z_val {
            ...
            // TODO: [ ] Implement the rest of the elements
            _ => panic!("Z value out of range. Not yet implemented!!!"), // Replace with appropriate error handling
        }
    ...
    mod tests {
        ...
        fn test_calc_occup_vec() {
            ...
            const ORB_NAMES: [&str; 18] = [
                "1s", "2s", "2px", "2py", "2pz", "3s", "3px", "3py", "3pz", "4s", "4px", "4py",
                "4pz", "3dxz", "3dyz", "3dz2", "3dx2y2", "3dxy",
            ];
            println!("Z_val: {}", z_val);
        ...
        fn test_calc_sad_guess() {
            ...
            let sad_guess = compute_sad_guess(&mol);
...
mod ext_huckel {
    ...
    // fn atomic_rhf(basis: &BasisSet, mol: &Molecule) -> Array2<f64> {
        // let no_ao = basis.no_ao();
        // let mut dens_guess = Array2::zeros((no_ao, no_ao));
        // let mut ao_offset = 0;
        // for atom in mol.atoms_iter() {
        //     let z_val = atom.z_val();
